...
class Genid {
	 ...
	 *     BaseTime: 1667232000000,  // 基础时间（ms 单位），不能超过当前系统时间
	...
	CalcId(useTimeTick) {
		const result = BigInt(useTimeTick << this._TimestampShift) + BigInt(this.WorkerId << this.SeqBitLength) +
